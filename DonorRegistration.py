...
## heading line
heading = Label(text="Donor Registration",font=("verdana",30,"bold"),fg="Yellow",bg="magenta").place(x=480,y=40)
...
NICinput = Entry(textvariable=NICno,width=23)
NICinput.place(x=730,y=310)
...
### BUTTON HERE
submitbutton = Button(root,text="SUBMIT",width="20",font=("Times New Roman (Times)",12,"bold"),fg="red",bg="yellow",command=store)
submitbutton.place(x=633,y=500)

helptbutton = Button(root,text="HELP",width="8",font=("Times New Roman (Times)",12,"bold"),fg="Red",bg="white",command=helpmessage)
helptbutton.place(x=647,y=550)

exittbutton = Button(root,text="EXIT",width="8",font=("Times New Roman (Times)",12,"bold"),fg="Red",bg="white",command=exitprgrm)
exittbutton.place(x=743,y=550)
